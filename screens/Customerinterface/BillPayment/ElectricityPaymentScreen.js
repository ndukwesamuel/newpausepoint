...
//   // ─── PINNED METER INPUT HEADER ────────────────────────────────────────────
//   // This sits ABOVE the ScrollView so the keyboard can never cover it
//   const renderMeterInputHeader = () => {
//     if (hasDebt) return null;
...
//           // Subtle shadow so it feels "pinned"
//           shadowColor: "#000",
...
//         {/* Verified badge shown instead of button once verified */}
//         {meterInfo && (
//           <View
//             style={{
//               backgroundColor: "#ECFDF5",
...
//         {/* The actual text input — always at the bottom of the header */}
//         <View style={{ flexDirection: "row", alignItems: "center" }}>
//           <TextInput
//             value={meterId}
//             onChangeText={handleMeterIdChange}
...
//             keyboardType="numeric"
//             maxLength={11}
//             editable={!meterInfo} // lock once verified
//             style={{
//               flex: 1,
//               borderWidth: 2,
//               borderColor: meterInfo
//                 ? "#10B981"
//                 : meterId.length === 11
//                   ? "#3B82F6"
//                   : "#E5E7EB",
...
//               fontWeight: "600",
//               letterSpacing: 1,
//               backgroundColor: meterInfo ? "#F0FDF4" : "#F9FAFB",
//               color: meterInfo ? "#065F46" : "#1F2937",
//             }}
//           />
//           {/* Digit counter badge */}
//           {meterId.length > 0 && meterId.length < 11 && (
...
//         >
//           {[
//             { icon: "✓", label: "No retyping meter IDs" },
//             { icon: "⚡", label: "Instant verification" },
//             { icon: "💾", label: "Save up to 10 meters" },
//           ].map((item, i) => (
//             <View
//               key={i}
//               style={{
...
//     if (hasDebt || !meterInfo) return null;

//     return (
//       <>
//         {/* Save / Already-saved indicator */}
//         <View
//           style={{
//             backgroundColor: "white",
//             borderRadius: 20,
...
//                       flex: 1,
//                       backgroundColor:
//                         walletUnits === unit.toString() ? "#3B82F6" : "#F3F4F6",
//                       borderRadius: 8,
//                       paddingVertical: 8,
//                       alignItems: "center",
//                     }}
...
//                         fontWeight: "600",
//                         color:
//                           walletUnits === unit.toString() ? "#fff" : "#374151",
//                       }}
//                     >
//                       {unit}
//                     </Text>
...
//                     style={{ fontSize: 12, color: "#6B7280", marginTop: 2 }}
//                   >
//                     {EMERGENCY_UNITS} units • ₦{EMERGENCY_DEBT.toLocaleString()}{" "}
//                     debt
//                   </Text>
//                 </View>
//                 <Switch
...
//        * Layout structure:
//        *  ┌─────────────────────────────┐
//        *  │  ScreenWrapper header        │  (ScreenWrapper handles this)
//        *  ├─────────────────────────────┤
//        *  │  PINNED: Meter input area    │  ← keyboard CANNOT reach here
//        *  ├─────────────────────────────┤
//        *  │  SCROLLABLE content          │  ← keyboard pushes this up
//        *  └─────────────────────────────┘
//        */}
//       <View style={{ flex: 1, backgroundColor: "#F8FAFC" }}>
//         {/* ── PINNED TOP: Meter input (keyboard-safe) ── */}
//         {renderMeterInputHeader()}

//         {/* ── SCROLLABLE BODY (keyboard pushes this up on Android too) ── */}
//         <KeyboardAvoidingView
//           style={{ flex: 1 }}
...
//             {/* Purchase body (save button + units + summary + buy) */}
//             {renderPurchaseBody()}

//             {/* Hint when no meter verified yet */}
//             {!meterInfo && !hasDebt && beneficiaries.length > 0 && (
//               <View
//                 style={{
//                   backgroundColor: "#F9FAFB",
...
//                   }}
//                 >
//                   💡 Select a saved meter above or type a new meter ID
//                 </Text>
//               </View>
//             )}
...
//               >
//                 Wallet: ₦{NORMAL_PRICE}/unit • Emergency: {EMERGENCY_UNITS}{" "}
//                 units = ₦{EMERGENCY_DEBT.toLocaleString()}
//               </Text>
//               <Text
//                 style={{
//                   textAlign: "center",
