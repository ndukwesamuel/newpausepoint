    ...
    <View style={styles.container}>
      ...
      >
        <View style={styles.content}>
          ...
          >
            ...
            {transaction.source && (
              <View style={styles.heroSourceBadge}>
                <MaterialCommunityIcons
                  name={transaction.source === "wallet" ? "wallet" : "bank"}
                  size={14}
                  color="#FFFFFF"
                />
          ...
          {/* Bank Transaction Details - Only for bank transactions */}
          {transaction.source === "bank" && transaction.bankData && (
            <View style={styles.bankDetailsCard}>
              ...
              <View style={styles.bankDetailRow}>
                <Text style={styles.bankDetailLabel}>Transaction Type:</Text>
                <Text style={styles.bankDetailValue}>
                  {transaction.bankData.attributes.transactionType}
                </Text>
              </View>

              <View style={styles.bankDetailRow}>
                <Text style={styles.bankDetailLabel}>Balance Before:</Text>
                <Text style={styles.bankDetailValue}>
                  ₦
                  {transaction.bankData.attributes.balanceBefore.toLocaleString()}
                </Text>
              </View>

              <View style={styles.bankDetailRow}>
                <Text style={styles.bankDetailLabel}>Balance After:</Text>
                <Text style={styles.bankDetailValue}>
                  ₦
                  {transaction.bankData.attributes.balanceAfter.toLocaleString()}
                </Text>
              </View>

              <View style={styles.bankDetailRow}>
                <Text style={styles.bankDetailLabel}>Direction:</Text>
                <View
                  style={[
                    styles.directionBadge,
                    {
                      backgroundColor:
                        transaction.bankData.attributes.direction === "Credit"
                          ? "#D1FAE5"
                          : "#FEE2E2",
                    },
                  ]}
                >
                  ...
                  >
                    {transaction.bankData.attributes.direction}
                  </Text>
                </View>
              </View>

              {transaction.bankData.attributes.transactionDate && (
                <View style={styles.bankDetailRow}>
                  <Text style={styles.bankDetailLabel}>Transaction Date:</Text>
                  <Text style={styles.bankDetailValue}>
                    {new Date(
                      transaction.bankData.attributes.transactionDate
                    ).toLocaleString()}
