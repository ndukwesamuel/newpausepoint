...
//                     onPress={() => handleAnnouncementPress(item.link)}
//                   >
//                     <MediumFontText
//                       data={item.title}
...
//                   <View style={styles.announcementSeparator} />
//                 )}
//                 // Add scrollEnabled to false for FlatLists within ScrollView if you want outer scroll to handle it
//                 // If you want internal scroll, ensure a fixed height/maxHeight
//                 scrollEnabled={false} // Let the parent ScrollView handle the overall scroll
//               />
//             ) : (
//               <RegularFontText
...
//               (
//                 item: GeneralData,
//                 index: number // Explicitly typing item here
//               ) => (
//                 <General key={item?.id} item={item} />
//               )
//             )}
...
//           {/* Dark Mode Toggle (if uncommented) */}
//           {/* <DarkModeToggle onDarkModeToggle={handleDarkModeToggle} /> */}
...
//           {/*
//           // Gradual Migration: Uncomment the <View> and its contents
//           // when you are ready to introduce and type the Advertisements section.
//           // Also ensure 'Advertisement' interface and 'sampleAdvertisements' data
//           // are uncommented at the top of this file.
//           */}
//           <View style={styles.sectionHeaderContainer}>
//             <MediumFontText
...
//           {/* Ensure these are inside the ScrollView to be visible when scrolled */}
//           <DeleteLAccount item={new_item} />
//           <Logout item={new_item} />
//         </ScrollView>
...
//   divider: {
//     borderColor: "#CFCDCD",
//     borderWidth: 0.5, // Reduced from 1 for a lighter look
...
//     marginBottom: 20,
//     paddingHorizontal: 20,
//     height: 120, // Fixed height for horizontal ads, this will scroll internally if more ads
//   },
//   advertItem: {
//     width: 300, // Fixed width for each ad
//     height: 100, // Fixed height for each ad
//     borderRadius: 10,
  ...
  return (
    <AppScreen>
      ...
      >
        {/* Wrap all scrollable content in a ScrollView */}
        <ScrollView contentContainerStyle={styles.scrollViewContent}>
          {/* Account Header (Always visible at the top, outside specific sections) */}
          ...
          <View style={styles.sectionContainer}>
            ...
            {/* Dark Mode Toggle (if uncommented, place within General section) */}
            {/* <DarkModeToggle onDarkModeToggle={handleDarkModeToggle} /> */}
          </View>
          ...
          */}
          ...
          {/* Logout and Delete Account Options (Always at the very bottom of scrollable content) */}
...
const styles = StyleSheet.create({
  ...
  advertisementsContainer: {
    marginBottom: 20,
    paddingHorizontal: 20,
    height: 120, // Fixed height for horizontal ads container
  },
  advertItem: {
    width: 300,
    height: 100,
