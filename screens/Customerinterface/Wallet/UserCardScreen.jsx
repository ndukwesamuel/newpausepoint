...
//   switch (result) {
//     case "granted":
//       return { color: "#059669", bg: "#ECFDF5", icon: "checkmark-circle", label: "Granted" };
//     case "denied":
//       return { color: "#DC2626", bg: "#FEF2F2", icon: "close-circle", label: "Denied" };
//     default:
...
//   const { date: startDate } = formatDateTime(card?.start_date) || {};
//   const { date: endDate } = formatDateTime(card?.end_date) || {};
...
//   return (
//     <View style={[histStyles.item, !isLast && histStyles.border]}>
...
//           <Text style={styles.headerSub}>Tap card to copy UID</Text>
//         </View> */}
